...
export class AIService {
  // Image Generation using Gemini 2.5 Flash Image - Fixed extraction logic
  async generateImage(prompt: string) {
    try {
      ...
      // Iterate through all parts of the first candidate to find image data
      ...
      // If no inlineData found, check safety reasons
